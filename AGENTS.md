...
- On desktop, the lower detail area uses three equal-width columns for order-size totals, latest board ranking, and the selected board's Top 5 stocks. The first ranked board is selected by default; clicking another board updates the Top 5 panel, and narrow screens stack the panels vertically.
